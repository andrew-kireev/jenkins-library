...
type detectExecuteScanOptions struct {
	...
	ScanMode                    string   `json:"scanMode,omitempty" validate:"possible-values=EPHEMERAL RAPID"`
...
func addDetectExecuteScanFlags(cmd *cobra.Command, stepConfig *detectExecuteScanOptions) {
	...
	cmd.Flags().StringVar(&stepConfig.ScanMode, "scanMode", os.Getenv("PIPER_scanMode"), "test")
			...
			Inputs: config.StepInputs{
				...
				Parameters: []config.StepParameters{
					...
					},
					{
						...
						Type:        "string",
						Mandatory:   false,
						Aliases:     []config.Alias{{Name: "detect/scanMode"}},
						Default:     os.Getenv("PIPER_scanMode"),
					},
					{
						Name:        "scanOnChanges",
						ResourceRef: []config.ResourceReference{},
